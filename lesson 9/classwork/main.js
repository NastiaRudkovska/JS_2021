...
//         div.innerText = `${member.name} ${member.surname} ${member.age}`
...
duration.style.justifyContent = 'space-around';
duration.style.fontSize = '18px';
...
monthDuration.innerText = ` Тривалість курсу - ${course.monthDuration} місяців`;
hourDuration.innerText = `   ${course.hourDuration} годин`;

block.append(title , duration , modulesDiv );
